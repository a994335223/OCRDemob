...
public class IDCardActivity extends AppCompatActivity {
    ...
    private boolean checkGalleryPermission() {
        int ret = ActivityCompat.checkSelfPermission(IDCardActivity.this, READ_EXTERNAL_STORAGE);
        if (ret != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(IDCardActivity.this, new String[]{READ_EXTERNAL_STORAGE}, 1000);
            return false;
        }
        return true;
    }
